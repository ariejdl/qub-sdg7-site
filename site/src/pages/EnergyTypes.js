        ...
        <div className="div1">
          ...
          <div className="flip">
            <div className={"card " + ((flipped === 0) ? "flipped": "") }>
              <div className="face front heading">Coal</div>
        ...
        <div className="div2">
         ...
         <div className="flip">
            <div className={"card " + ((flipped === 1) ? "flipped": "") }>
              <div className="face front heading">Wind</div>
              <div className="face back">
        ...
        <div className="div3">
           <div className="flip">
            <div className={"card " + ((flipped === 2) ? "flipped": "") }>
              <div className="face front heading">Oil</div>
              <div className="face back">
        ...
        <div className="div4">
           <div className="flip">
            <div className={"card " + ((flipped === 3) ? "flipped": "") }>
              <div className="face front heading">Solar</div>
              <div className="face back">
        ...
        <div className="div5">
           <div className="flip">
            <div className={"card " + ((flipped === 4) ? "flipped": "") }>
              <div className="face front heading">Natural Gas</div>
              <div className="face back">
        ...
        <div className="div6">
           <div className="flip">
            <div className={"card " + ((flipped === 5) ? "flipped": "") }>
              <div className="face front heading">Hydrogen</div>
              <div className="face back">
