...
export const EnergyTypesPage = () => {
  ...
  return (
    <div>
      ...
      <table style={{ width: "100%" }} className="title-table">
        <thead>
          <tr>
        ...
        <div className="div3">
           <div className="flip">
            <div className={"card " + ((flipped === 2) ? "flipped": "") }>
              ...
              <div className="face back">
                  <h2>Oil</h2>
                  <p>One reason nations may transition away from traditional energy sources is if this source starts to rise in price. Oil reserves and oil trading are massive industries in global economic activity. It is suggested that the change in crude oil price invariably affects global CO2 emissions<sup>4</sup>. This further reflects how economic growth can translate into environmental impact, by forcing polluting countries into clean energy sources<sup>5</sup>. Oil is the second largest contributor to CO2 emissions, accounting for 11.84 billion tonnes<sup>6</sup>. Global policy to limit crude oil burning and combat global warming includes carbon pricing through taxes for usage—likewise, subsidies for nations to implement green energy usage<sup>7</sup>. Scholars do see success in the crude oil market decreasing in the future largely due to electric vehicles being set to replace traditional fuel vehicles<sup>8</sup>. However, we are well off our target of access to clean energy for all.</p>
              </div>
            </div>
          </div>
        </div>
