...
export const ThreePillarsPage = () => {
  ...
  return <div>
    ...
    <ul className="unstyled references">
      ...
      <li>[2] Boussemart, J. P., Herve L., Zhiyang, S., Vivan, V. (2020) ‘Performance analysis for three pillars of sustainability’, Journal of productivity analysis, 53(3), pp. 305–320.doi: https://doi.org/10.1007/s11123-020-00575-9.</li>
      ...
      <li>[5] Tjahjadi, B., Soewarno, N., Karima T. E., Satarsa A. A. P. (2023) ‘Business strategy, spiritual capital and environmental sustainability performance: mediating role of environmental management process’, Business process management journal, 29(1), pp. 77–99. Doi: https://doi.org/10.1108/BPMJ-11-2021-0718.</li>
    </ul>
