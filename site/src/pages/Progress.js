...
export const ProgressPage = () => {
  ...
  return <div>
    ...
    <ul className="unstyled references">
      ...
      <li>Our World in Data (2021) Share of Population with access to electricity, 2021, Available at: https://ourworldindata.org/grapher/share-of-the-population-with-access-to-electricity?country=~TCD (Accessed: 20 October 2024).</li>
    </ul>
