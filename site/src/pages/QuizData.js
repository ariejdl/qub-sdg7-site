...
export const QUIZ_DATA = [{
  ...
  options: [
    {
      value: 'Yes',
      result: 'It is overlooked in the business sector how much our software choices can impact our energy use. For example, artificial intelligence packages have been gaining traction of late. However, the energy used to run data centres large enough to sustain these AI technologies is immense. Your business should prioritise a transition to Cloud-Based services for productivity. Open software packages and server storage solutions make training streamlined and cost-efficient for the business. Likewise, cloud-based service providers such as Google and Amazon Web Services have committed to their data centres being powered by renewable energy sources, making this an easy solution to reduce the business’ carbon footprint[2].'
    },
    {
      value: 'No',
      result: 'Switching existing technology to eco-friendly devices and peripherals can often save expenses over time. Factors from reduced energy consumption and potential tax benefits from reduced energy consumption can lead to financial advantages. Low-power and standby energy saving of new household technology manufactured after 2013 must be implemented under EU Law. This is modelled to save up to 9.3 to 12.1 billion Euros in 2025 from the energy reduction—likewise, an annual avoidance of CO2 emissions of up to 10.7 MT[1]. Monitor office space for technology manufactured before this point and consider upgrading to eco-friendly solutions.'
    }
  ]
}, {
  id: 'public.2',
  ...
  options: [
    {
      value: 'Yes',
      result: 'It is important to know what area of your business is using the most energy so we can continue to reduce these. Smart meters and automated systems to identify energy efficiencies can greatly reduce energy consumption. The real-time usage of smart meters in Northern Ireland since 2002 has been associated with a decline in energy consumption of 11-17%[4]. Smart meter solutions can provide online audits of wasted energy in the workplace. A financial benefit is found by reducing this, improving the business’s carbon footprint.'
    },
    {
      value: 'No',
      result: 'By 2032, an estimated 80% of the lighting market will be covered by LED technology. In this timeframe, the price of LED lighting is expected to halve while its luminous energy efficiency is expected to double[3]. Energy bills of office spaces have been shown to decrease significantly compared to old halogen light solutions, which are very inefficient, as up to 90% of their energy is lost as heat.  Likewise, LED bulbs have been shown to last much longer, up to 10 years on average. For energy-saving solutions in the workplace, the transition to this technology is one of the most widely adopted today.'
    }
  ]
  /* private */
},{
    ...
    /* ngo */
    {
      ...
      options: [
        {
          value: 'Tarmac',
          result: 'We understand that wasted space is a certainty in office spaces from car parks to peripheral land. However, office rooftops should be considered as a great place to install solar panel solutions for clean energy solutions. Within an 18-month return period, office buildings with roof-mounted solar panels experienced a decrease in energy usage by 18%[12]. Likewise, the efficiency of solar panels can decrease by as much as 40% without proper maintenance and cleaning[13]. Having a space that is easily accessed, such as a roof space, is vital to ensure viability within the business. Solutions such as solar panels will become more widespread as the technology improves, but adopting clean energy usage early can vastly decrease your business’s carbon footprint.'
        },
        {
          value: 'Grassland',
          result: 'Large engineering projects to sequester CO2 from the atmosphere may be more efficient. These are very unattainable for businesses. However, nature-based solutions such as tree planting can have a huge impact on your business’ carbon reduction. As of 2019, atmospheric CO2 reached a level of 417.7 ppm[10]. Through the planting of trees, the carbon sequester rate has been up to 0.80 tonnes (Hectare/Year)[11]. Trees also offer additional benefits to the business, including reduced air pollution and noise reduction. Vast energy use is a necessity for every business. However, regreening our urban spaces can be an achievable step toward our clean energy goal.'
        }
      ]
}];